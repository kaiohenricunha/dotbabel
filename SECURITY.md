...
1. **GitHub Private Vulnerability Reporting** — Use the "Report a vulnerability" button on the [Security Advisories](https://github.com/kaiohenricunha/dotbabel/security/advisories) page.
...
- The `@dotbabel/dotbabel` npm package (everything under `plugins/dotbabel/`)
- Shell scripts (`bootstrap.sh`, `sync.sh`)
- CI workflow templates generated by `dotbabel-init`
