...
# Env overrides. The legacy DOTCLAUDE_* fallbacks were removed in 3.0.0.
DOTBABEL_VERSION="${DOTBABEL_VERSION:-latest}"
DOTBABEL_SKIP_BOOTSTRAP="${DOTBABEL_SKIP_BOOTSTRAP:-}"
