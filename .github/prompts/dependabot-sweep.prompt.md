---
# dotbabel:generated — do not edit directly. Source: .claude/commands/dependabot-sweep.md. Regenerate with `dotbabel project-sync`.
name: dependabot-sweep
description: >
  Batch-triage all open Dependabot PRs in the current repo using parallel
  subagents. Produces a risk-annotated table and merges only safe bumps.
---
