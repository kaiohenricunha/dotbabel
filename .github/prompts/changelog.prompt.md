---
# dotbabel:generated — do not edit directly. Source: .claude/commands/changelog.md. Regenerate with `dotbabel project-sync`.
name: changelog
description: >
  Generate a changelog entry from git history. Defaults to commits since the
  last tag or the last 20 commits.
