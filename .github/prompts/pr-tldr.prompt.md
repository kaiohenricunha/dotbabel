---
# dotbabel:generated — do not edit directly. Source: .claude/commands/pr-tldr.md. Regenerate with `dotbabel project-sync`.
name: pr-tldr
description: >
  Explain a PR in 2-3 plain-language lines for a PO or PM: what it gives us, not
  how it works.
