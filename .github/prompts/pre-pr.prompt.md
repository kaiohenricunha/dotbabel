---
# dotbabel:generated — do not edit directly. Source: .claude/commands/pre-pr.md. Regenerate with `dotbabel project-sync`.
name: pre-pr
description: >
  Pre-PR quality gate: simplify changed code, security-review the diff, run the
  quality profile, and surface a go/no-go summary before opening a pull request.
