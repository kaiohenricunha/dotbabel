---
# dotbabel:generated — do not edit directly. Source: .claude/commands/merge-pr.md. Regenerate with `dotbabel project-sync`.
name: merge-pr
description: >
  Merge a pull request only after full local verification and a passing quality
  gate.
argument-hint: "[PR#]"
---
