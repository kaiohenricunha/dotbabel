---
# dotbabel:generated — do not edit directly. Source: .claude/skills/crossplane-specialist/SKILL.md. Regenerate with `dotbabel project-sync`.
name: crossplane-specialist
description: >
  Deep-dive Crossplane platform review: XRD design, Composition correctness,
  provider config audit, managed resource health, and GitOps integration. Use
  for structured investigations of stuck Claims, composition pipeline bugs, and
