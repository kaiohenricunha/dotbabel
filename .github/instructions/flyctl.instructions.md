---
# dotbabel:generated — do not edit directly. Source: .claude/skills/flyctl/SKILL.md. Regenerate with `dotbabel project-sync`.
name: flyctl
description: >
  ...
  SSH, proxy, check health, list releases, and show status. Auto-discovers the
  app from fly.toml in the current directory. Side-effectful ops on
  prod-flavored apps require typed confirmation matching the app name. Rollback
