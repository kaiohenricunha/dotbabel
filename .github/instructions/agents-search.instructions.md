---
# dotbabel:generated — do not edit directly. Source: .claude/skills/agents-search/SKILL.md. Regenerate with `dotbabel project-sync`.
name: agents-search
description: >
  Discover, search, and manage Claude Code agents. Use when you want to find
