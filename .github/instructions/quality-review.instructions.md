---
# dotbabel:generated — do not edit directly. Source: .claude/skills/quality-review/SKILL.md. Regenerate with `dotbabel project-sync`.
name: quality-review
description: >
  Check changed code against the resolved dotbabel quality policy, then review
  semantic risks that tools cannot judge. Triggers on: "quality review",
