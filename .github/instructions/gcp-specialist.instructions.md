---
# dotbabel:generated — do not edit directly. Source: .claude/skills/gcp-specialist/SKILL.md. Regenerate with `dotbabel project-sync`.
name: gcp-specialist
description: >
  Deep-dive Google Cloud architecture review, debugging, and service design. Use
  for structured investigations of GCP-specific issues, IAM or cost audits, and
