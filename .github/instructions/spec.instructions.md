---
# dotbabel:generated — do not edit directly. Source: .claude/skills/spec/SKILL.md. Regenerate with `dotbabel project-sync`.
name: spec
description: >
  Create structured engineering specs through interactive pairing. Use when the
  user wants to create a spec, design doc, technical specification, architecture
