---
# dotbabel:generated — do not edit directly. Source: .claude/skills/terragrunt-specialist/SKILL.md. Regenerate with `dotbabel project-sync`.
...
description: >
  ...
  Terragrunt layouts, dependency graphs, remote state config, and hook
