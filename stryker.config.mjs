...
export default {
  ...
  mutate: [
    ...
    "plugins/dotbabel/src/check-attestation-adoption.mjs",
    "plugins/dotbabel/src/review-evidence.mjs",
    "plugins/dotbabel/src/review-gate-inputs.mjs",
    "plugins/dotbabel/src/review-complete.mjs",
