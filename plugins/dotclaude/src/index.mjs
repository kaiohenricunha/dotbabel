/**
 * Public barrel for `@kaiohenricunha/dotclaude`.
 *
 * Consumer contract:
 *   import { createHarnessContext, validateSpecs, EXIT_CODES, ValidationError } from "@kaiohenricunha/dotclaude";
 *
...
/** The `@kaiohenricunha/dotclaude` package version at import time. */
