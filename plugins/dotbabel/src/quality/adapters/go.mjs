...
export const goAdapter = Object.freeze({
  ...
  plan(component, _policy, changeSet, profile) {
    ...
    const explicit = explicitPlans(component, profile, includeTests);
    ...
    const plans = [...explicit, ...makeRepositoryPlans(component, profile, claimed, includeTests)];
