...
const VALID_STATUSES = new Set(["draft", "approved", "implementing", "done"]);
...
const VAGUE_QUANTITY =
  /\b(fast|slow|quick(?:ly)?|responsive|performant|scalable|efficient|timely|prompt(?:ly)?|reasonable|acceptable|adequate|sufficient|minimal|negligible|low|high|large|small|soon|frequent(?:ly)?|rare(?:ly)?|often|periodic(?:ally)?|regularly|as needed|reliable|robust)\b/i;
