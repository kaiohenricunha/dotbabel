...
maturity: draft
description: >
  Explain anything in 2-3 plain-language lines: a PR, a file, a directory, a URL, or a concept.
argument-hint: "[PR number | branch | path | URL | topic] (default: current branch vs origin/main)"
model: haiku
related: [pr-tldr]
---
